...
unlocked to sign the BSUSD-Qt.app bundle.
...
allowing somebody to distribute a BSUSD-Qt.app or bsusd-qt-setup.exe with a valid
...
that the bsusd-qt.exe file inside the installer had not been tampered with.
