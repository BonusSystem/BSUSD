...
These are the dependencies currently used by BSUSD. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/bsusdnl
Keybase  - https://keybase.io/team/bsusd/
