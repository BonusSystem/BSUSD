...
const QString BITCOIN_IPC_PREFIX("bsusd:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bsusd-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bsusd-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bsusd-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bsusd: links
...
//
// OSX-specific way of handling bsusd: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bsusd: URIs
