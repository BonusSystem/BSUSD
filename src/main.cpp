...
#if defined(NDEBUG)
# error "BSUSD cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BSUSD Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BSUSD also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BSUSD also requires low S in sigs
