 ...
 * between bsusdd, and bsusd-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.org/bonsys/>";
    const std::string URL_WEBSITE = "<https://bon-sys.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The BSUSD Developers", 2023, 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find BSUSD useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BSUSD More version %s\n", FormatFullVersion());
}
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    else if (nDonationPercentage > 99)
        nDonationPercentage = 99;
#endif
