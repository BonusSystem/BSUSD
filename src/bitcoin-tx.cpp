...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bsusd-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bsusd-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bsusd transaction") + "\n" +
              "  bsusd-tx [options] -create [commands]   " + _("Create hex-encoded bsusd transaction") + "\n" +
              "\n";
